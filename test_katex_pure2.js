...
function renderPureKaTeXText(text) {
    ...
    // Catch any remaining un-delimited LaTeX commands like \frac{a}{b}, \sqrt{a}, \theta, etc.
...
console.log('Testing Pure KaTeX HTML Generation (with output: html)...');
...
console.log('Contains visible raw \\frac text outside HTML tags?:', />\\frac</.test(renderedHtml));
console.log('Sample Rendered Output Snippet:', renderedHtml.slice(0, 300));
