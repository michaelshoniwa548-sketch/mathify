...
console.log('Testing Protected Currency + Correct Order Parsing:');
...
console.log('Contains $160 as currency?:', output.includes('&#36;160') || output.includes('$160'));
console.log('Clean Output Text Snippet:\n', output.replace(/<[^>]+>/g, ' ').replace(/\s+/g, ' '));
